...
files {
	...
	MAME_DIR .. "src/emu/netplay_memory_block.cpp",
	MAME_DIR .. "src/emu/netplay_memory_block.h",
	MAME_DIR .. "src/emu/netplay_packet.cpp",
	MAME_DIR .. "src/emu/netplay_packet.h",
	MAME_DIR .. "src/emu/netplay_peer.cpp",
	MAME_DIR .. "src/emu/netplay_peer.h",
	MAME_DIR .. "src/emu/netplay_socket_emscripten.cpp",
	MAME_DIR .. "src/emu/netplay_socket.h",
	MAME_DIR .. "src/emu/netplay_input_state.cpp",
	MAME_DIR .. "src/emu/netplay_input_state.h",
