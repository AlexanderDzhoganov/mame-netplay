...
files {
	...
	MAME_DIR .. "src/emu/netplay/util.h",
	MAME_DIR .. "src/emu/netplay/memory.cpp",
	MAME_DIR .. "src/emu/netplay/memory.h",
	MAME_DIR .. "src/emu/netplay/packet.h",
	MAME_DIR .. "src/emu/netplay/peer.cpp",
	MAME_DIR .. "src/emu/netplay/peer.h",
