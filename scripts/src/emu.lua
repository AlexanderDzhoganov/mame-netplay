...
files {
	...
	MAME_DIR .. "src/emu/netplay_socket_js.cpp",
	MAME_DIR .. "src/emu/netplay_socket.h",
	MAME_DIR .. "src/emu/netplay_socket_def.h",
	MAME_DIR .. "src/emu/netplay_input.cpp",
	MAME_DIR .. "src/emu/netplay_input.h",
	MAME_DIR .. "src/emu/netplay_serialization.cpp",
	MAME_DIR .. "src/emu/netplay_serialization.h",
